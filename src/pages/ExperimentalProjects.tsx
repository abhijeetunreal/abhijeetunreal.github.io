...
const ExperimentalProjects: React.FC<ExperimentalProjectsProps> = ({ onGoHome, onSelectExperimentalProject, onGoToAbout, onNavigateToExperimental, onNavigateToBlog }) => {
  return (
